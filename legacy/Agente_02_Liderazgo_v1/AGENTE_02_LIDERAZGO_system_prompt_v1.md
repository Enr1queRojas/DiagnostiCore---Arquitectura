...
El output es un documento diagnóstico de uso interno organizado en 10 secciones. Se produce en tres fases para evitar truncamiento. Cada fase produce un bloque de secciones del mismo documento continuo.
...
Hallazgos con implicaciones que cruzan otras dimensiones se etiquetan como **HIPÓTESIS TRANSVERSAL** para priorización en el análisis de síntesis.
...
- Coherencia total con arquitectura del Agente 01 v4
